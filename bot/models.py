...
class OutageType(NamedTuple):
    unplanned = Outage(  # type: ignore
        ...
        'region=40&'
        'district=093778F4-8378-414B-9905-7A145E4F140F&'
        'place=%D0%9A%D0%BE%D1%80%D0%BE%D0%BA%D0%B8%D0%BD%D0%BE&'
    ...
    emergency = Outage(  # type: ignore
        title='Экстренное отключение',
        url='https://www.mrsk-cp.ru/local/templates/main/components/bitrix/form.result.new/'
        'inform_about_disconnect/emergency_outages.php?'
        'region=40&'
        'district=093778F4-8378-414B-9905-7A145E4F140F&'
        'district_name=%D0%94%D0%B7%D0%B5%D1%80%D0%B6%D0%B8%D0%BD%D1%81%D0%BA%D0%B8%D0%B9&'
        'place=%D0%9A%D0%BE%D1%80%D0%BE%D0%BA%D0%B8%D0%BD%D0%BE',
    )
